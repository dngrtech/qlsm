...
| --- | --- | --- | --- |
| `v1.14.1` | 2026-07-09 | [#142](https://github.com/dngrtech/qlsm/pull/142) | Added MinQLX log viewing from instance actions, including rotated `minqlx.log.N` files with Last N Lines and All filters. |
