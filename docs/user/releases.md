...
| --- | --- | --- | --- |
| `v1.13.4` | 2026-07-02 | — | Fix preset ZIP import always failing with "No file provided": the shared API client's default JSON content type was silently corrupting the multipart upload before it left the browser. |
