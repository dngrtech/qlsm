...
| --- | --- | --- | --- |
| `v1.11.0` | 2026-05-26 | [#93](https://github.com/dngrtech/qlsm/pull/93) | Hook manager: dedicated `user-hooks/` directory with full CRUD — upload, download, replace, rename, delete, and per-file descriptions — plus inline editing and a delete confirmation modal in the Hooks tab. |
