...
| --- | --- | --- | --- |
| `v1.14.3` | 2026-07-10 | — | Pin the minqlx build to a fixed upstream commit instead of a floating branch, and add a patch backporting the `damage` event/dispatcher. |
