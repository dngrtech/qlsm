...
| --- | --- | --- | --- |
| `v1.13.11` | 2026-07-07 | [#140](https://github.com/dngrtech/qlsm/pull/140) | Add a Hooks tab to the Add Instance modal, showing a preset's user hooks with their LD_PRELOAD order and enabled/disabled status. |
