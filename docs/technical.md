...
* **UI Components (New):**
   ...
   *   `frontend-react/src/components/presetManager/` (`PresetManagerModal`, load/save tabs, and preset-name combobox) provides the unified Load / Save / Overwrite preset workflow shared by Deploy New Instance and Edit Config.
