...
class spec_switch_guard(minqlxtended.Plugin):
    def __init__(self):
        self.add_hook("team_switch", self.handle_team_switch, priority=minqlxtended.Priority.HIGH)
        self.add_hook("team_switch_attempt", self.handle_team_switch_attempt, priority=minqlxtended.Priority.HIGHEST)
    ...
    def handle_team_switch_attempt(self, player, old_team, new_team, target):  # target added by minqlxtended's team_switch_attempt signature; unused here
