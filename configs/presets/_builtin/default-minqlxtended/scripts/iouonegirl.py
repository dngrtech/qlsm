...
class iouonegirlPlugin(minqlxtended.Plugin):
        ...
        for line in res.iter_lines():
            if line.startswith(b'VERSION'):
                ...
                # If routine check and it's not alright.
                    ...
                    if self.get_cvar("qlx_autoupdate_iouplugins", int):
                        minqlxtended.console_command("echo Autoupdating iouonegirl's {} plugin.".format(self._name))
                        ...
                        except Exception as e: minqlxtended.console_command("echo Error: {}".format(e))
                return
            ...
            if line.startswith(b'VERSION'):
                ...
                # If routine check and it's not alright.
                    ...
                    if self.get_cvar('qlx_autoupdate_iouplugins', int):
                        ...
                        except Exception as e: minqlxtended.console_command("echo IouoneError: {}".format(e))
                return
    ...
    def iouonegirlplugin_cmd_install(self, player, msg, channel):
        ...
        @minqlxtended.next_frame
        def done():
            minqlxtended.reload_plugin(msg)
    ...
    def iouonegirlplugin_cmd_list(self, player, msg, channel):
        ...
        return minqlxtended.Return.STOP # once is enough, thanks
    ...
    def iouonegirlplugin_handle_player_connect(self, player, is_bot):
    ...
    def iouonegirlplugin_update(self, player, msg, channel):
        @minqlxtended.next_frame
        def ready():
            minqlxtended.reload_plugin(self._name)
    ...
    def delaymsg(self, messages, interval = 1):
        def msg(m):
            return lambda: minqlxtended.CHAT_CHANNEL.reply("^7{}".format(m)) if m else None
